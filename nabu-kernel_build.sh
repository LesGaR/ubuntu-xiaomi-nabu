...
cp arch/arm64/boot/Image.gz ../linux-xiaomi-nabu/boot/vmlinuz-$1.0-sm8150
cp arch/arm64/boot/dts/qcom/sm8150-xiaomi-nabu.dtb ../linux-xiaomi-nabu/boot/dtb-$1.0-sm8150
